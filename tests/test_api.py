...
class ApiTest(unittest.TestCase):
    def test_to_sql_uses_dsql_generator_for_postgres_like_queries(self):
    ...
    def test_compile_and_to_sqlglot_return_matching_ast(self):
        ...
        self.assertEqual(compiled, alias)
